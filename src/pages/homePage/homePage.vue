        ...
        <view class="flex-1	 flex-col w-11/12 h-4/5 justify-start  items-end m-auto relative">
          ...
          <view class="flex flex-col w-full h-auto absolute bottom-1 ">
            ...
            <view class="flex flex-row h-1/5 w-full text-center items-center m-1">
              <view class="w-auto h-auto bg-gray-600  bg-opacity-40 rounded items-center px-1.5"><text class="text-white  text-xs ">{{sceneryStar}}</text></view>
              <view class=" h-auto bg-blue-400 rounded px-1.5"><text class="text-white font-medium text-xs	  ">{{scenerySore}}</text></view>
